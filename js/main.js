...
function actualizarCarritoUI(){
    fetch('http://localhost/ProyectosK/Shop/api/carrito/api-carrito.php?action=mostrar')
    .then(response =>{
...
const addItemToCarrito = id =>{
    fetch('http://localhost/ProyectosK/Shop/api/carrito/api-carrito.php?action=add&id=' + id)
    .then(response =>{
...
const removeItemFromCarrito = id =>{
    fetch('http://localhost/ProyectosK/Shop/api/carrito/api-carrito.php?action=remove&id=' + id)
    .then(res =>{
        return res.json();
    })
    .then(data =>{
...
/*$(document).ready(function(){
    $('#sendbox').on("submit", function(e){
        e.preventDefaul(); //Bloquea o actualiza el form
        var form = $(this);
